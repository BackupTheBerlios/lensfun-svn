...
def detect_local_timestamp():
    for path in ["/var/lib/", "/usr/local/share/", "/usr/share/"]:
        filepath = path + "lensfun/timestamp.txt"
...
read_location("http://svn.berlios.de/viewvc/lensfun/trunk/data/db/")
read_location("http://wilson.bronger.org/")
